...
public interface IssueEHKDFlows {
...
//        private String notaryName;
        ...
        private final Logger logger = LoggerFactory.getLogger(IssueEHKDFlows.class);
...
//        }
        ...
        public Initiator(String accountName, Long amount)  {
            this.accountName = accountName;
            this.amount = amount;
            this.progressTracker = tracker();
        }
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final EHKDType token = new EHKDType();
            ...
            FungibleToken fungibleToken = new FungibleToken(new Amount(this.amount, issuedTokenType), anonymousParty, EHKDType.getContractAttachment());
...
//            final Party notary = getServiceHub().getNetworkMapCache().getNotary(CordaX500Name.parse(notaryName)); // METHOD 1
            ...
            logger.info("IssueEHKDFlows select notary[{}]", notary);
